...
```bash
root@b917f14ed690:/workspace# make run-example
./sidecar examples/hello
tahini secret: 1b2433a8c122c6a512fa7cf78cd18f0f950c0be47a37f144cf6c50910e827807
hello, world!!
```
